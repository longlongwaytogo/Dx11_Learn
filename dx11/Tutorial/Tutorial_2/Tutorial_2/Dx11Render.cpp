...
Dx11Render::Dx11Render(void):m_vsync_enabled(false),m_pSwapChain(NULL),m_pD3dDevice(NULL),m_pD3dDeviceContext(NULL),m_pDepthStencilState(NULL),
	m_pDepthStencilView(NULL),m_pRenderTargetView(NULL),m_pDepthBackBuf(NULL),m_pRasterState(NULL)
{
}
